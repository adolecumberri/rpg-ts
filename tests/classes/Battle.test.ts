...
describe('Battle class tests', () => {
    ...
    beforeEach(() => {
        battle = new Battle();
        character1 = new Character({ id: 1, name: 'Char1', stats: { hp: 10, attack: 2, defense: 1, attackSpeed: 1, attackInterval: 2 } });
        character2 = new Character({ id: 2, name: 'Char2', stats: { hp: 10, attack: 3, defense: 2, attackSpeed: 1, attackInterval: 3 } });

        character3 = new Character({ id: 3, name: 'Char3', stats: { hp: 10, attack: 2, defense: 1, attackSpeed: 1, attackInterval: 1 } });
        character4 = new Character({ id: 4, name: 'Char4', stats: { hp: 10, attack: 4, defense: 2, attackSpeed: 1, attackInterval: 3 } });
    ...
    describe('tests tal vez repetidos', () => {
        test('fight between Characters', () => {
            ...
            const char1 = new Character({ id: 1, name: 'Char1', stats: { hp: 10, attack: 2, defense: 1, speed: 1, attackSpeed: 1, attackInterval: 1 } });
            const char2 = new Character({ id: 2, name: 'Char2', stats: { hp: 10, attack: 3, defense: 2, speed: 1, attackSpeed: 1, attackInterval: 1 } });
        ...
        test('fight between Teams', () => {
            ...
            const team1 = new Team({
                members: [
                    new Character({ id: 1, name: 'Char1', stats: { hp: 10, attack: 2, defense: 1, speed: 1, attackSpeed: 1, attackInterval: 1 } }),
                    new Character({ id: 2, name: 'Char2', stats: { hp: 10, attack: 3, defense: 2, speed: 1, attackSpeed: 1, attackInterval: 1 } })
                ]
            });

            const team2 = new Team({
                members: [
                    new Character({ id: 3, name: 'Char3', stats: { hp: 10, attack: 2, defense: 1, speed: 1, attackSpeed: 1, attackInterval: 1 } }),
                    new Character({ id: 4, name: 'Char4', stats: { hp: 10, attack: 3, defense: 2, speed: 1, attackSpeed: 1, attackInterval: 1 } })
                ]
            });
